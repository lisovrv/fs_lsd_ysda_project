...
def train(args, train_loader, encoder_lmk, encoder_target, generator, decoder,
          bald_model, smooth_mask, device):
...
if __name__ == "__main__":
    ...
    bald_model = F_mapping(mapping_lrmul= args.mapping_lrmul, 
                           mapping_layers=args.mapping_layers,
                           mapping_fmaps=args.mapping_fmaps,
                           mapping_nonlinearity = args.mapping_nonlinearity).to(device)
    bald_model.eval()
    ...
    train(args, train_loader, encoder_lmk, encoder_target, generator,
          decoder, bald_model, smooth_mask, device)